...
void Game::placeSquares(sf::RenderWindow& window) {
	int multiplierX = 1;
	int multiplierY = 1;
	int x = 0;
...
void Game::colorSquare(sf::RectangleShape& shape, const sf::Color color) {
	shape.setFillColor(color);
}
bool Game::doesContainMouseCursor(sf::RectangleShape& shape, sf::RenderWindow& window) {
